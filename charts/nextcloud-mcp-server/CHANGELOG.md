...
## nextcloud-mcp-server-0.104.14 (2026-09-23)

## nextcloud-mcp-server-0.104.13 (2026-09-18)

## nextcloud-mcp-server-0.104.12 (2026-09-14)

## nextcloud-mcp-server-0.104.11 (2026-09-11)

## nextcloud-mcp-server-0.104.10 (2026-09-10)

## nextcloud-mcp-server-0.104.9 (2026-09-06)

## nextcloud-mcp-server-0.104.8 (2026-08-28)

## nextcloud-mcp-server-0.104.7 (2026-08-28)

## nextcloud-mcp-server-0.104.6 (2026-08-23)

## nextcloud-mcp-server-0.104.5 (2026-08-23)

## nextcloud-mcp-server-0.104.4 (2026-08-21)

## nextcloud-mcp-server-0.104.3 (2026-08-18)

## nextcloud-mcp-server-0.104.2 (2026-08-18)

## nextcloud-mcp-server-0.104.1 (2026-08-18)
...
## nextcloud-mcp-server-0.103.0 (2026-08-12)

### Feat

- **helm**: expose forwardedAllowIps for proxied deployments

## nextcloud-mcp-server-0.102.10 (2026-08-12)

## nextcloud-mcp-server-0.102.9 (2026-08-11)

## nextcloud-mcp-server-0.102.8 (2026-08-09)

## nextcloud-mcp-server-0.102.7 (2026-08-05)

## nextcloud-mcp-server-0.102.6 (2026-08-04)

## nextcloud-mcp-server-0.102.5 (2026-08-03)

## nextcloud-mcp-server-0.102.4 (2026-08-03)

## nextcloud-mcp-server-0.102.3 (2026-08-03)

## nextcloud-mcp-server-0.102.2 (2026-08-02)

## nextcloud-mcp-server-0.102.1 (2026-08-02)

### Fix

- **helm**: resolve the worker binary via PATH, not an absolute venv path

## nextcloud-mcp-server-0.102.0 (2026-08-02)

### Feat

- **helm**: expose SEARCH_RERANK_* settings for optional reranking
...
## nextcloud-mcp-server-0.100.4 (2026-07-31)

## nextcloud-mcp-server-0.100.3 (2026-07-29)
...
## nextcloud-mcp-server-0.99.5 (2026-07-21)

## nextcloud-mcp-server-0.99.4 (2026-07-20)

## nextcloud-mcp-server-0.99.3 (2026-07-19)

## nextcloud-mcp-server-0.99.2 (2026-07-19)

## nextcloud-mcp-server-0.99.1 (2026-07-19)

## nextcloud-mcp-server-0.99.0 (2026-07-19)

### Feat

- **nextcloud-mcp-server**: expose documentPipeline.markdownMaxPages

## nextcloud-mcp-server-0.98.1 (2026-07-19)
...
## nextcloud-mcp-server-0.96.8 (2026-07-16)

## nextcloud-mcp-server-0.96.7 (2026-07-16)

## nextcloud-mcp-server-0.96.6 (2026-07-16)

## nextcloud-mcp-server-0.96.5 (2026-07-15)

## nextcloud-mcp-server-0.96.4 (2026-07-15)

## nextcloud-mcp-server-0.96.3 (2026-07-15)

## nextcloud-mcp-server-0.96.2 (2026-07-14)

## nextcloud-mcp-server-0.96.1 (2026-07-13)

## nextcloud-mcp-server-0.96.0 (2026-07-12)

### Feat

- **nextcloud-mcp-server**: profiling config + appVersion 0.137.0

## nextcloud-mcp-server-0.95.2 (2026-07-12)

## nextcloud-mcp-server-0.95.1 (2026-07-10)
...
## nextcloud-mcp-server-0.93.2 (2026-07-06)

## nextcloud-mcp-server-0.93.1 (2026-07-05)
...
## nextcloud-mcp-server-0.92.9 (2026-07-04)

## nextcloud-mcp-server-0.92.8 (2026-07-04)

## nextcloud-mcp-server-0.92.7 (2026-07-03)

## nextcloud-mcp-server-0.92.6 (2026-07-03)

## nextcloud-mcp-server-0.92.5 (2026-07-03)

## nextcloud-mcp-server-0.92.4 (2026-07-03)

## nextcloud-mcp-server-0.92.3 (2026-07-02)

## nextcloud-mcp-server-0.92.2 (2026-07-02)

## nextcloud-mcp-server-0.92.1 (2026-07-02)

## nextcloud-mcp-server-0.92.0 (2026-06-30)

### Feat

- **nextcloud-mcp-server**: expose SEARCH_MODE for keyword-only search

## nextcloud-mcp-server-0.91.0 (2026-06-29)

### Feat

- **nextcloud-mcp-server**: make Deployment update strategy configurable

## nextcloud-mcp-server-0.90.1 (2026-06-28)

### Fix

- **nextcloud-mcp-server**: bump appVersion to 0.126.5
...
## nextcloud-mcp-server-0.88.9 (2026-06-26)

## nextcloud-mcp-server-0.88.8 (2026-06-25)

## nextcloud-mcp-server-0.88.7 (2026-06-24)

## nextcloud-mcp-server-0.88.6 (2026-06-23)

## nextcloud-mcp-server-0.88.5 (2026-06-23)

## nextcloud-mcp-server-0.88.4 (2026-06-23)

## nextcloud-mcp-server-0.88.3 (2026-06-22)

## nextcloud-mcp-server-0.88.2 (2026-06-22)

## nextcloud-mcp-server-0.88.1 (2026-06-21)

## nextcloud-mcp-server-0.88.0 (2026-06-21)

### Feat

- **nextcloud-mcp-server**: expose OCR timeout/oversize/batch knobs + scoped values.schema.json

## nextcloud-mcp-server-0.87.6 (2026-06-21)
...
## nextcloud-mcp-server-0.87.2 (2026-06-19)

## nextcloud-mcp-server-0.87.1 (2026-06-18)
...
- **nextcloud-mcp-server**: honor per-tier replicaCount: 0 in ingest workers

## nextcloud-mcp-server-0.82.0 (2026-06-13)

### Feat

- **nextcloud-mcp-server**: per-tier ingest worker Deployments

## nextcloud-mcp-server-0.81.0 (2026-06-13)

### Feat

- Bump nextcloud-mcp-server helm chart application version

## nextcloud-mcp-server-0.80.0 (2026-06-12)

### Feat

- Bump nextcloud-mcp-server helm chart application version

## nextcloud-mcp-server-0.79.0 (2026-06-11)

### Feat

- Bump helm chart app version

## nextcloud-mcp-server-0.78.0 (2026-06-11)

### Feat

- **nextcloud-mcp-server**: scrape ingest-worker metrics via Service + ServiceMonitor
...
## nextcloud-mcp-server-0.76.1 (2026-06-09)

## nextcloud-mcp-server-0.76.0 (2026-06-07)

### Feat

- Bump helm chart app version

## nextcloud-mcp-server-0.75.1 (2026-06-06)

## nextcloud-mcp-server-0.75.0 (2026-06-06)

### Feat

- Bump helm chart app version

## nextcloud-mcp-server-0.74.1 (2026-06-06)

## nextcloud-mcp-server-0.74.0 (2026-06-05)

### Feat

- **nextcloud-mcp-server**: expose OCR escalation tuning knobs

## nextcloud-mcp-server-0.73.0 (2026-06-05)

### Feat

- **nextcloud-mcp-server**: wire tiered PDF pipeline and Mistral OCR

## nextcloud-mcp-server-0.72.1 (2026-06-05)

## nextcloud-mcp-server-0.72.0 (2026-06-04)

### Feat

- Bump helm chart app version

## nextcloud-mcp-server-0.71.0 (2026-06-04)

### Feat

- Bump helm chart app version

## nextcloud-mcp-server-0.70.1 (2026-06-04)

### Fix

- Pin to correct appversion

## nextcloud-mcp-server-0.70.0 (2026-06-04)
...
## nextcloud-mcp-server-0.67.6 (2026-06-03)

## nextcloud-mcp-server-0.67.5 (2026-06-02)

## nextcloud-mcp-server-0.67.4 (2026-06-02)

## nextcloud-mcp-server-0.67.3 (2026-06-01)

## nextcloud-mcp-server-0.67.2 (2026-06-01)

## nextcloud-mcp-server-0.67.1 (2026-06-01)

## nextcloud-mcp-server-0.67.0 (2026-05-31)

### Feat

- Bump nextcloud-mcp-server helm chart application version

## nextcloud-mcp-server-0.66.0 (2026-05-30)

### Feat

- Bump nextcloud-mcp-server helm chart application version

## nextcloud-mcp-server-0.65.7 (2026-05-30)

## nextcloud-mcp-server-0.65.6 (2026-05-30)

## nextcloud-mcp-server-0.65.5 (2026-05-26)

## nextcloud-mcp-server-0.65.4 (2026-05-25)

## nextcloud-mcp-server-0.65.3 (2026-05-17)

### Fix

- **nextcloud-mcp-server**: bump appVersion 0.87.1 → 0.87.2
...
- **nextcloud-mcp-server**: render MCP_DEPLOYMENT_MODE (ADR-022)

## nextcloud-mcp-server-0.63.3 (2026-05-17)

## nextcloud-mcp-server-0.63.2 (2026-05-12)

## nextcloud-mcp-server-0.63.1 (2026-05-11)

## nextcloud-mcp-server-0.63.0 (2026-05-10)

### Feat

- **nextcloud-mcp-server**: add auth.oidc.discoveryUrl

## nextcloud-mcp-server-0.62.5 (2026-05-10)

### Fix

- **nextcloud-mcp-server**: bump appVersion to 0.84.2

## nextcloud-mcp-server-0.62.4 (2026-05-10)

### Fix

- Bump nextcloud-mcp-server app version

## nextcloud-mcp-server-0.62.3 (2026-05-10)

### Fix

- Bump nextcloud-mcp-server app version

## nextcloud-mcp-server-0.62.2 (2026-05-10)

### Fix

- Bump nextcloud-mcp-server app version

## nextcloud-mcp-server-0.62.1 (2026-05-10)

### Fix

- **nextcloud-mcp-server**: wire OIDC client creds in login-flow mode
...
- **nextcloud-mcp-server**: use dot-separated OAuth scopes

## nextcloud-mcp-server-0.61.5 (2026-05-08)

## nextcloud-mcp-server-0.61.4 (2026-05-08)

## nextcloud-mcp-server-0.61.3 (2026-05-03)

## nextcloud-mcp-server-0.61.2 (2026-05-03)

## nextcloud-mcp-server-0.61.1 (2026-05-01)

## nextcloud-mcp-server-0.61.0 (2026-04-28)

### Feat

- **helm**: allow storageClass override for login-flow PVC

## nextcloud-mcp-server-0.60.1 (2026-04-28)

### Fix

- **helm**: trigger dataStorage for qdrant sidecar mode
...
## nextcloud-mcp-server-0.59.2 (2026-04-07)

## nextcloud-mcp-server-0.59.1 (2026-04-07)

### Fix

- **ci**: use yq syntax compatible with GitHub Actions runner
...
- **helm**: use uvx for commitizen and PAT for tag pushes
...
## nextcloud-mcp-server-0.58.14 (2026-03-28)

## nextcloud-mcp-server-0.58.13 (2026-03-28)
...
## nextcloud-mcp-server-0.58.8 (2026-03-23)

## nextcloud-mcp-server-0.58.7 (2026-03-22)
